...
map_colormap = colors.ListedColormap(['white', 'black', 'red'])

local_map = map_colormap(obs["agent_0"][0][..., 0].astype(np.int))
coverable = map_colormap(obs["agent_0"][0][..., 1].astype(np.int))
agent_pos_map = map_colormap(obs["agent_0"][0][..., 2])


map = map_colormap(obs["agent_0"][1][..., 0].astype(np.int))
